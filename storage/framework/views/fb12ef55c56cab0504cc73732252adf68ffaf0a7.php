...
<body>
                    ...
                    <div class="row pt-5">
                        <div class="col-6">
                            <input type="number" class="form-control border-radius6" id="amount" aria-describedby="name"
                                placeholder="Enter Amount" required value="<?php echo e($amount); ?>" readonly>
                        ...
                        <div class="col-12 mb-2">
                            <input type="text" class="form-control border-radius6" id="wallet_address"
                                aria-describedby="name" placeholder="Enter Destination Address" value=<?php echo e($address); ?> readonly>
                        ...
                        <div class="col-12 mb-2">
                            <input type="text" class="form-control border-radius6" id="remarks" aria-describedby="name"
                                placeholder="Remarks" value="<?php echo e($remarks); ?>" readonly>
                        ...
                        <div class="col-12 mb-2">
                            <input type="number" class="form-control border-radius6" id="inr_value"
                                aria-describedby="name" placeholder="INR Value" readonly value="<?php echo e($amount); ?>">
    ...
    <script>
        ...
        // setting status
        let email = "<?php echo e($email_status); ?>";
        let mobile = "<?php echo e($mobile_status); ?>";
        let kyc = "<?php echo e($kyc_status); ?>";
        ...
        $(document).on('click', '#confirm_pay', function() {
            ...
            //     }
                ...
                //     },
                //     method: "post",
                //     url: "<?php echo e(route('user.check')); ?>",
                //     data: {
                //         amount: $('#amount').val(),
            ...
            else if (kyc != "verified") location.href = "<?php echo e(route('kyc')); ?>" + "<?php echo e('?user_id='); ?>" + resp.user_id;
        });
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.success == "success") {
                            ...
                            location.href = "<?php echo e(route('kyc')); ?>" + "<?php echo e('?user_id='); ?>" + resp.user_id;
                        }  else {
													alert("Mobile OTP is failed. Please try again.");
													$('#mobile_getotp').removeClass("disabled");
												}
...
<?php /**PATH D:\RapidGame\laravel\rapidpay\resources\views/external_users/index.blade.php ENDPATH**/ ?>