                            ...
                            <div>
                                ...
                                <div class="p-3 py-4 boxblue text-center">
                                    ...
                                    <h4 class=" text-center text-blue pb-3">Upload Documents</h4>
																		<h3 style="color: cornflowerblue"><?php if(!empty($status)): ?> <?php echo e($status); ?> <?php endif; ?></h3>
                                    <form method="POST" action="<?php echo e(route('kyc-manual')); ?>" enctype="multipart/form-data">
																				<?php echo csrf_field(); ?>
																				<input type="hidden" name="user_id" value="<?php echo e($user_id); ?>" />
                                        <div class="form-group">
                                            <label for="formFileLg" class="form-label text-blue">Please Upload Doc
                                                front</label>
                                            <input class="form-control form-control-lg" id="front" type="file" name="front"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="formFileLg" class="form-label text-blue">Please Upload Doc
                                                back</label>
                                            <input class="form-control form-control-lg" id="back" type="file" name="back"/>
                                        </div>
        ...
        const veriff = Veriff({
            ...
            onSession: function(err, response) {
                $.ajax({
                    ...
                    url: "<?php echo e(route('kyc-process')); ?>",
...
<?php /**PATH D:\RapidGame\laravel\rapidpay\resources\views/direct_users/kyc.blade.php ENDPATH**/ ?>