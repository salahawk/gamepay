                        ...
                        <div class="col-6">
                            <select id="myDropdown" style="width:100%">
                                ...
                                <option value="1" class="text-blue"
                                    data-imagesrc="<?php echo e(asset('assets/img/JR_blue_d.png')); ?>" data-description="">JXRUPE
                                </option>
                                <option value="2" class="text-blue"
                                    data-imagesrc="<?php echo e(asset('assets/img/jusd_d.png')); ?>" data-description="">JUSD
                                </option>
                            </select>
                        </div>
