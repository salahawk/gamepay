...
<div class="new" style="display: block;">
			<form method="post" action="<?php echo e($signValues['gwUrl']); ?>" name="frm1">
			  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="PAY_ID" class="signuptextfield" value="<?php echo e($signValues['PAY_ID']); ?>" autocomplete="off" /></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">ORDER ID: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" id="ORDER_ID" name="ORDER_ID" class="signuptextfield" value="<?php echo e($signValues['ORDER_ID']); ?>" autocomplete="off" /></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">AMOUNT: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="AMOUNT" class="signuptextfield" value="<?php echo e($signValues['AMOUNT']); ?>"  autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">TXNTYPE: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="TXNTYPE" class="signuptextfield" value="<?php echo e($signValues['TXNTYPE']); ?>" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">CUSTOMER NAME: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CUST_NAME" class="signuptextfield" value="<?php echo e($signValues['CUST_NAME']); ?>" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>			
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CUST_STREET_ADDRESS1" class="signuptextfield" value="<?php echo e($signValues['CUST_STREET_ADDRESS1']); ?>" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>					
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">CUSTOMER ZIP: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CUST_ZIP" value="<?php echo e($signValues['CUST_ZIP']); ?>" class="signuptextfield" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">CUSTOMER PHONE: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CUST_PHONE" value="<?php echo e($signValues['CUST_PHONE']); ?>" class="signuptextfield" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">CUSTOMER EMAILID: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CUST_EMAIL" class="signuptextfield" value="<?php echo e($signValues['CUST_EMAIL']); ?>" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">PRODUCT DESC: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="PRODUCT_DESC" class="signuptextfield" value="<?php echo e($signValues['PRODUCT_DESC']); ?>" autocomplete="off"/></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">CURRENCY CODE: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="CURRENCY_CODE" class="signuptextfield" value="<?php echo e($signValues['CURRENCY_CODE']); ?>"autocomplete="off" /></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <td width="65%" align="left" valign="middle"><input
                        type="text" name="RETURN_URL" class="signuptextfield" value="<?php echo e($signValues['RETURN_URL']); ?>" autocomplete="off" /></td>
                <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" align="right" valign="middle" class="labelfont">HASH: </td>
                    <td width="65%" align="left" valign="middle"><input
                        type="text" name="HASH" class="signuptextfield11" value="<?php echo e($signValues['HASH']); ?>" autocomplete="off" id="hash" /></td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="3" align="center" valign="middle">&nbsp;</td>
...
<?php /**PATH D:\RapidGame\laravel\rapidpay\resources\views/merchants/sender.blade.php ENDPATH**/ ?>