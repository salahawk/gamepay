			  ...
			  <div class="av-b d total-dep">
				<div class="box-cs">
					 <span>Net Amount </span>
					  <input type="text" class="inn-box" readonly="" value="&#8377; <?php echo e($rowDatasum['amount']-$rowDatasum2['fees']); ?>">
				 </div>
			  </div>
		  	<?php endif; ?>
        </div>
	  	...
	  	<form action="" method="post">
			  <section class="frm-sec">
				<div class="row">
				  ...
				  <center>
					<button type="submit" class="btn btn-outline frm-btn" name="Search_val" value="settlementAdd">Get</button><br>
...
<?php $__env->startSection('footer_script'); ?>
	...
	<script>
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.view_deposit.data')); ?>",
            type: "GET"
        },
        columns: [
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Collabrate_bluepadu\gamepay\resources\views/admin/view_deposit.blade.php ENDPATH**/ ?>