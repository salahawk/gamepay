            ...
            <div class="col-12">
              <div>
                ...
                <div class="p-3 py-4 boxblue text-center">
                  ...
                  <form method="POST" action="{{ route('securepay.kyc.manual') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      <label for="formFileLg" class="form-label text-blue">Please Upload Doc
                        front</label>
                      <input class="form-control form-control-lg" id="front" type="file" name="front" required />
                    </div>
                    <div class="form-group">
                      <label for="formFileLg" class="form-label text-blue">Please Upload Doc
                        back</label>
                      <input class="form-control form-control-lg" id="back" type="file" name="back" required />
                    </div>
