...
<link rel="shortcut icon" href="img/fev.png" type="image/x-icon">
  ...
  <div class="row justify-content-center align-items-center">
    <div class="col-lg-10">
      <div class="middlepage1 shadow p-4">
        <div class="alert-info p-3 rounded"> <img src="{{asset('assets/img/help.png')}}" width="25" class="float-left mr-3 mt-2" />
        ...
        <div class="text-center mainimg">
          ...
          <img src="img/complete.png" class="mb-4" /> </div>
        <div class="row mb-4 d-flex">
          <div class="col-12 col-md-4">
            <div class="text-center box3 p-3 p-md-4 h-100"> <img src="{{asset('assets/img/icon1.png')}}" class="mb-2 float-left float-md-none mr-2 mr-md-0" />
              <p class="pb-0 mb-0">Note: Go to UPI ID linked mobile app or Click on the notification from your UPI ID linked mobile app</p>
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="text-center box3 p-3 p-md-4 h-100"> <img src="{{asset('assets/img/icon2.png')}}" class="mb-2 float-left float-md-none mr-2 mr-md-0" />
              <p class="pb-0 mb-0">Note: Check pending transactions</p>
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="text-center box3 p-3 p-md-4 h-100"> <img src="{{asset('assets/img/icon3.png')}}" class="mb-2 float-left float-md-none mr-2 mr-md-0" />
        ...
        <div class="row">
          <div class="col-12">
            <div class="box3 rounded p-3"> <img src="img/help.png" width="30" class="float-left mr-3 mt-2" />
