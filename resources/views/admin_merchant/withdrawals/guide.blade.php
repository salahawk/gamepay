...
<main>
    <div class="container-fluid px-4">
        <h6 class="mt-4 pb-4 fw-bold">Payout API Integration </h6>
        <div class="admincard">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>IFSC code</td>
                                    <td>Compulsory</td>
                                    <td>IFSC pattern validation required</td>
                                </tr>
                                <tr>
                                    <th scope="row">16</th>
                                    <td>Account No</td>
                                    <td>Compulsory</td>
                                    <td>Min length 9 and Max length 18 (Only string allowed )</td>
                                </tr>
                                <tr>
                                    <th scope="row">17</th>
                                    <td>Payer Address</td>
                                    <td>Compulsory</td>
                                    <td>Payer address pattern validation required</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Eurl</td>
                                    <td>Compulsory</td>
                                    <td>Merchant’s Error url Where Gamepay sends the failure response)</td>
                                </tr>
                                <tr>
                                    <th scope="row">17</th>
                                    <td>Curl</td>
                                ...
                                <tr>
                                    ...
                                    <td>Txn Hash</td>
                                    <td>Compulsory</td>
                                    <td>Max length 12 character </td>
                                </tr>
                                <tr>
                                    <th scope="row">17</th>
                                    <td>hash(Checksum)</td>
                                    <td>Compulsory</td>
                                    <td>Hash or Checksum =sha512(key|txnid|amount|customername|email|phone| crypto|network|receiver|sender|remarks|kycstatus|emailstatus|mobilestatus| panstatus|ifsc|accountno|payeraddress|txnhash|surl|eurl|curl|salt) (SALT &KEY which provided by gamepay)</td>
                                </tr>
                            </tbody>
                        </table>
                    </li>
