          ...
          <div class="row">
            <div class="col-md-6 pb-3">
              <div class="form-group">
                <input name="firstname" type="text" placeholder="First Name" class="validate form-control" required="">
                <span class="input-focus-effect"></span>
              </div>
            </div>
            <div class="col-md-6 pb-3">
              <div class="form-group">
                <input name="lastname" type="text" placeholder="Last Name" class="validate form-control" required="">
                <span class="input-focus-effect"></span>
              </div>
            </div>
            ...
            <div class="col-md-12 pb-3">
              <div class="form-group">
                <input type="number" placeholder="Mobile" name="mobile" class="validate form-control" required="">
                <span class="input-focus-effect"></span>
              </div>
            </div>
            <div class="col-md-12 pb-3">
              <div class="form-group">
                <input type="password" placeholder="Password" name="password" class="validate form-control" required="">
                <span class="input-focus-effect"></span>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="send">
                <button class="m-btn m-btn-theme2nd w-100" type="submit" name="send">Register</button>
              </div>
            </div>
            <div class="col-md-12">
		...
		<div class="pt-3">
			<form class="contactform pt-3" method="post" action="{{route('login')}}">
                <div class="row">
                  ...
                  <div class="col-md-12  pb-3">
                    <div class="form-group">
                      <input type="passsword" placeholder="Password" name="password" class="validate form-control" required="">
                      <span class="input-focus-effect"></span>
                    </div>
                  </div>
                   <div class="col-md-12  pb-3">
                  ...
                  <div class="col-md-12">
                    <div class="send">
                      <button class="m-btn m-btn-theme2nd w-100" type="submit" name="send"> Login</button>
                    </div>
                  </div>
                </div>
              </form>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          <div class="feature-box-02">
            ...
            <p>Coinpaise.com is backed by a team of world-class financial experts and the best technology talent. We work hard to implement time-tested investment strategies and develop an investment experience that’s personalized for you.</p>
			  <p>Our mission is to make payments simple, through our innovative thinking and skillful team, by bringing the future technologies to you today.</p>
           
          </div>
        </div>
        <!-- col --> 
         <div class="col-md-6 sm-m-30px-t"> <img src="{{asset('assets/img/banner2.png')}}" title="" alt=""> </div>
      </div>
      <!-- row --> 
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-15px-tb sm-m-30px-tb">
          <div class="price-table-01">
            ...
            <div class="pt-body">
              <ul>
                <li>We’ve left no stone unturned to make coinpaise is the most secure exchange. </li>
        ...
        <div class="col-md-4 m-15px-tb">
          <div class="price-table-01">
            ...
            <div class="pt-body">
              <ul>
                <li>Buy and trade bitcoin, ethereum and other popular cryptocurrencies with your fiat currency.</li>
